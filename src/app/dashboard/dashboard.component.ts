...
@Component({
  ...
  standalone: true,
  imports: [ReactiveFormsModule, FormsModule, CommonModule, MatRadioModule, MatIconModule, HttpClientModule, MatButtonModule, MatInputModule, MatStepperModule, MatFormFieldModule, AsyncPipe, VotesuccessComponent],
...
export class DashboardComponent {
  ...
  constructor(public formbuilder: FormBuilder, public http: HttpClient, public routes: Router, public cookiesService: CookiesService) {
